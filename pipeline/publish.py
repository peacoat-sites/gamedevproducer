...
SITE_PERSONAS = {
    ...
    "gamedevproducer": {
        "tone": "authoritative and practical -- written by someone who has shipped games, not just studied them. Clear, direct, framework-oriented. Occasionally opinionated. Avoids jargon without explanation.",
        "authors": [
            {"name": "Marcus Webb",   "bio": "Senior producer with 10+ years across AAA and indie. Obsessed with pre-production frameworks and green-light documentation."},
            {"name": "Priya Nair",    "bio": "Associate producer turned executive. Writes about team dynamics, escalation patterns, and the human side of game dev."},
            {"name": "Jordan Reyes",  "bio": "Scrum master turned producer. Translates agile methodology into game dev reality -- what works, what breaks."},
            {"name": "Chris Okafor",  "bio": "Lives in spreadsheets. Post-mortem analyst, milestone tracker, and the person who actually reads all the GDC slides."}
        ],
        "ymyl": False,
        "disclaimer": ""
    },
