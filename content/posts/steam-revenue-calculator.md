...
Enter your game's price, your estimated peak CCU or wishlist count, and your genre. The calculator applies a genre multiplier to account for the variance in CCU-to-ownership ratios across different markets (simulation games, for instance, tend to have more dedicated daily players than casual puzzle games at the same ownership level).
