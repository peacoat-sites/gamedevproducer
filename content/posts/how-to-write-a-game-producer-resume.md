...
categories: ["careers"]
tags: ["write", "game", "producer", "resume"]
author: "Stephen Brenish"
author_slug: "stephen-brenish"
author_title: "Lead Game Producer"
author_bio: "Stephen Brenish is a Lead Game Producer at Epic Games (Fortnite, Unreal Engine) and founder of GameDevProducer, with 14+ years shipping and running live games at scale (previously Senior Program Manager at Blizzard Entertainment). Certified ScrumMaster."
slug: "how-to-write-a-game-producer-resume"
affiliate_disclosure: true
faqs:
  - q: "How long should a game producer resume be?"
    a: "Two pages is standard for anyone with five or more years of experience. One page if you're early career. Three pages is almost never appropriate and signals that you haven't made editorial decisions about your own work history, which is not a great look for a producer."
  - q: "Should I include game jams or personal projects on my producer resume?"
    a: "Yes, with caveats. If you produced (not just played in) a game jam, shipped an indie game, or managed a modding team, include it. If you 'participated in' a jam as a designer or developer, it's less relevant. The key question is: did you perform production functions, or just show up?"
  - q: "Do I need to list every game I worked on, including ones that got cancelled?"
    a: "Cancelled projects are real experience and you can absolutely include them. Frame it honestly: 'Produced until project was cancelled at pre-alpha due to studio restructuring.' Hiring managers understand this. What you shouldn't do is pad the list with projects you were tangentially adjacent to."
  - q: "How do I handle it if I don't have any shipped titles yet?"
    a: "This is the hard truth: ship something. A game jam submission counts. A prototype you released on itch.io counts. Volunteer as a producer on an indie team. The 'shipped titles' section can list a $0-revenue itch.io release if the work you did was real production work. The gap between 'aspiring producer' and 'junior producer' in hiring is almost always the presence or absence of shipped work, however small."
  - q: "Should I include my GPA or college degree on a game producer resume?"
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Lead every bullet with a shipped title, team size, or dollar figure, vague process language gets filtered out in 30 seconds.</li><li style="margin:5px 0">Game producer resumes need a "shipped titles" section; this is non-negotiable for mid-to-senior roles.</li><li style="margin:5px 0">ATS optimization matters less at most game studios than it does in corporate hiring, a human reads most submissions.</li><li style="margin:5px 0">One page is not the rule; two pages is standard for anyone with 5+ years of experience.</li><li style="margin:5px 0">Tailor the resume per role type: mobile, AAA, indie, and live ops producers all need different emphasis.</li></ul></div>
...
*Photo: [Minh Phuc](https://www.pexels.com/@mintworkspace) via Pexels*