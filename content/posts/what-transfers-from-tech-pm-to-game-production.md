...
faqs:
  - q: "Do I need to have shipped a game to be taken seriously as a game producer?"
    a: "No, but you need to be honest about it and you need to move fast to understand the production specifics of your team's genre and platform. What gets you taken seriously is competence, curiosity, and protecting your team's time. Nobody cares about your resume six months in. They care whether you can be relied on."
  - q: "Should I get a game production certification?"
    a: "The Certified Scrum Master credential transfers fine and many studios recognize it. The Project Management Professional (PMP) has mixed reception in games. Smaller studios often see it as corporate overhead. The most useful credential you can get right now is shipping something, even a game jam project, so you understand the full production cycle from your team's perspective rather than just the coordination layer."
  - q: "How long does the adjustment period realistically take?"
    a: "Expect six months before you feel fluent and twelve months before you feel genuinely effective. That's not a knock on your background. Game production has enough domain-specific knowledge that the ramp is real regardless of how strong your incoming skills are."
  - q: "Is Agile actually used in game development?"
...
This is called polish creep, and it's one of the top killers of indie and mid-size game projects. Your job is to make it visible without crushing the creative drive that makes games worth playing. That balance is genuinely hard, and it takes time to calibrate.
...
The fastest way to earn trust across disciplines: show up to their standups for the first month and say almost nothing. Ask one good question per session. Learn what "done" looks like in their pipeline before you start setting any expectations about it. An animator's workflow from concept to rigged, weighted, and in-engine is completely different from a software engineer's ticket-to-merged flow. If you try to manage both with the same metrics on day one, you'll create friction that takes months to undo.

Read **"The Art of Game Design" by Jesse Schell** even though it's not a production book. Understanding how game designers think will make you significantly more effective in every conversation you have. Jason Schreier's **"Blood, Sweat, and Pixels"** is essential reading for understanding the actual human and organizational pressures that blow up game projects. Neither of these are fluffy reads. They'll change how you see your role.
...
### Do I need to have shipped a game to be taken seriously as a game producer?

No, but you need to be honest about it and you need to move fast to understand the production specifics of your team's genre and platform. What gets you taken seriously is competence, curiosity, and protecting your team's time. Nobody cares about your resume six months in. They care whether you can be relied on.

### Should I get a game production certification?

The **Certified Scrum Master** credential transfers fine and many studios recognize it. The **Project Management Professional (PMP)** has mixed reception in games. Smaller studios often see it as corporate overhead. The most useful credential you can get right now is shipping something, even a game jam project, so you understand the full production cycle from your team's perspective rather than just the coordination layer.

### How long does the adjustment period realistically take?

Expect six months before you feel fluent and twelve months before you feel genuinely effective. That's not a knock on your background. Game production has enough domain-specific knowledge that the ramp is real regardless of how strong your incoming skills are.

### Is Agile actually used in game development?

Yes, but rarely by the book. Most studios run a hybrid: sprint structure borrowed from Scrum, milestone-based planning from waterfall, and a lot of informal iteration that doesn't show up in any framework. Your job is to make whatever process exists more visible and more predictable, not to implement textbook Agile.

### What's the biggest mistake tech PMs make when switching to game production?

Optimizing for process correctness over team trust. Coming in with a better system than the studio currently uses doesn't matter if you haven't built enough credibility for people to follow it. Fix the culture of your Jira board after you've fixed your relationships.
