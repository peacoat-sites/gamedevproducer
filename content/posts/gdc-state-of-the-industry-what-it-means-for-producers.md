...
faqs:
 - q: "What does the GDC State of the Industry report actually cover?"
   a: "The report covers developer sentiment across topics including employment conditions, platform priorities, genre focus, technology adoption, and industry outlook. It's published annually and based on a survey sent to GDC's registered attendee and newsletter audience. The sample size is typically 2,000 to 3,000 respondents. It's a broad snapshot, most useful for identifying trends over multiple years rather than drawing conclusions from any single data point."
 - q: "Should I be worried about job security as a producer right now?"
   a: "Worried enough to be proactive, not worried enough to be paralyzed. Producers who document their output, maintain external professional relationships, and develop genuine cross-disciplinary fluency are in a better position than those who rely entirely on institutional goodwill. Keep your portfolio of shipped milestones updated. Know your numbers."
 - q: "How should producers talk to studio leadership about the industry report findings?"
   a: "Bring the data in as context, not as an argument. If you're using industry numbers to justify a production change, connect them directly to your studio's specific situation. Leadership responds to 'here's what the trend means for our next milestone' much better than 'the industry report says things are bad.'"
 - q: "Are small studios or indie teams affected differently by these trends?"
...
3. **Build a contractor bench proactively.** The layoff wave created a large pool of experienced freelancers. Knowing who you'd call before you need them is a competitive advantage.
4. **Document what your team produced per sprint.** If cuts come, you want data that shows output, not just busyness.
