...
1. Someone proposes a change (usually the publisher)
2. You estimate the impact: time, resources, cost
3. You agree together on how to absorb it: slip the date, add budget, cut something else, or some combination
4. You document it and update the addendum
5. Everyone signs off before work starts
