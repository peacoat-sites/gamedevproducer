...
The second flaw is the buffer month. That single month at the end doesn't work.
...
Now, for each phase between milestones, build what I call a "feature budget." List every feature, system, and piece of content that needs to be done to reach the next milestone. Estimate the time for each one. Then take your total available person-weeks for that phase, and multiply by 0.6. That's your real available capacity. The other 40% goes to bugs, iteration, meetings, sick days, and the constant friction of doing creative technical work with humans.

If your feature list doesn't fit in the 60%, you have a scope problem, not an estimation problem. Cut before you start building, not after you've half-built everything.
...
What you're looking for each week: are you tracking ahead or behind on this phase's feature budget? Are any dependencies blocked? Has anything been added to scope since last week? Feature creep is sneaky, and it almost always comes from enthusiasm, which makes it hard to say no to. What's the team's actual capacity next week versus assumed capacity?
...
If you're a solo dev, I'd actually argue this matters even more. You're the only check on your own scope creep and optimism bias, and both will absolutely eat your project if you let them compound for even a couple of months unexamined.

For actual books on this stuff: *The Art of Game Design* by Jesse Schell isn't a production book, but the lens it gives you on what games actually are helps you make faster scope decisions. On the pure production side, *Project Management for Game Developers* by John Hight and Jeannie Novak is dated in some tooling recommendations but still has the clearest articulation I've found of milestone-based planning for games specifically. If you want something more current and indie-focused, Tanya Short and Tarn Watson's *Procedural Generation in Game Design* has chapters that accidentally contain some of the most honest project planning wisdom in print.
...
When you're behind, you have four real options. Pretending you don't have to choose between them is how projects die:
...
Add people. Usually the most expensive option and frequently slower in the short term because of onboarding costs. Not usually the right answer unless you have very specific, discrete, parallelizable work.
